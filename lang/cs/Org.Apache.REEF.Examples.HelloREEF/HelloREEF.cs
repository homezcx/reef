            ...
            switch (name)
            {
                ...
                case AzureBatch:
                    return AzureBatchRuntimeClientConfiguration.ConfigurationModule
                        ...
                        .Set(AzureBatchRuntimeClientConfiguration.AzureStorageHttpProxyRequestQueueName, @"#################")
                        .Set(AzureBatchRuntimeClientConfiguration.AzureStorageHttpProxyResponseQueueName, @"##################")
                        .Set(AzureBatchRuntimeClientConfiguration.DriverHTTPConnectionRetryInterval, "#############")
                        .Build();
